...
//select * from sonar.Project p inner join  sonar.Employee e on p.id=e.pid
        ...
        Query query =  entityManager
                .createQuery(" select  p from ProjectEntity p  ",
                        com.neoteric.entityclasses.ProjectEntity.class);
...
//        );
        ...
        Query query = entityManager.createQuery(
                ...
                com.neoteric.entityclasses.EmployeeEntity.class);
...
//        CriteriaQuery<EmployeeEntity> criteriaQuery = criteriaBuilder.createQuery(com.neoteric.entityclasses.EmployeeEntity.class);
//        Root<EmployeeEntity> entityRoot = criteriaQuery.from(com.neoteric.entityclasses.EmployeeEntity.class);
